...
add wave -noupdate -label {Contributors: VGA_G} -group {Contributors: sim:/FSM_tb/VGA_G} /FSM_tb/VIDEO_CONTROLLER/VGA_controller/pixel_color
add wave -noupdate /FSM_tb/VIDEO_CONTROLLER/VGA_controller/pixel_color
add wave -noupdate -label {Contributors: pixel_color} -group {Contributors: sim:/FSM_tb/VIDEO_CONTROLLER/VGA_controller/pixel_color} /FSM_tb/VIDEO_CONTROLLER/bank1_out
add wave -noupdate -label {Contributors: pixel_color} -group {Contributors: sim:/FSM_tb/VIDEO_CONTROLLER/VGA_controller/pixel_color} /FSM_tb/VIDEO_CONTROLLER/bank2_out
add wave -noupdate -label {Contributors: pixel_color} -group {Contributors: sim:/FSM_tb/VIDEO_CONTROLLER/VGA_controller/pixel_color} /FSM_tb/VIDEO_CONTROLLER/video_bank_sel
...
add wave -noupdate /FSM_tb/VIDEO_CONTROLLER/VGA_controller/h_BLANK
add wave -noupdate /FSM_tb/VIDEO_CONTROLLER/VGA_controller/v_BLANK
...
WaveRestoreCursors {{Cursor 1} {55932800 ps} 0} {{Cursor 2} {3441204200 ps} 0} {{Cursor 3} {436876200 ps} 0} {{Cursor 4} {180397300 ps} 0}
...
update
WaveRestoreZoom {1031351900 ps} {6824734300 ps}
